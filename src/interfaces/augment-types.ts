...
import { AddressHash, BTCTransaction, BTCTxLog, BtcAddress, CandidateTx, OutPoint, Params, TransactionInput, TransactionOutput, TxType, WithdrawRecord } from 'bool-network-js/interfaces/btcBridge';
