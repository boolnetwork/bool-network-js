...
import type { AddressHash, BTCTransaction, BTCTxLog, BestHeader, BlockHeader, BlockHeaderu32, BtcAddress, CandidateTx, NetWork, OutPoint, Params, PartialMerkleTreeForTransport, ScriptType, TransactionInput, TransactionOutput, TransportRelayTx, TxType, UTXO, WithdrawRecordT } from 'bool-network-js/interfaces/btcBridge';
import type { Authorities, AuthoritiesChangeType, CitaHeader } from 'bool-network-js/interfaces/citaBridge';
import type { DaoList, MakerProposal } from 'bool-network-js/interfaces/dao';
import type { AmountType, BidDetailT, BidT, CancelOrMatch, DepthInfo, DepthItem, MultiNodeIndex, Node, NodeIndex, OrderInfo, OrderPair, OrderStatus, OrderType, PerMill, PriceType, RegionT } from 'bool-network-js/interfaces/dex';
import type { ActionRecord, BestHeaderT, Bloom } from 'bool-network-js/interfaces/ethBridge';
import type { OraclePrice, TimeWrapOf } from 'bool-network-js/interfaces/feed';
import type { Meta } from 'bool-network-js/interfaces/genericErc20';
import type { DealId, OrderId } from 'bool-network-js/interfaces/market';
import type { AccountList, Bids, Feed, List, PawnType, Time, Vault } from 'bool-network-js/interfaces/stablecoin';
import type { ChainKind, DepositDetail, TokenControl, TokenDetail, WithdrawDetail } from 'bool-network-js/interfaces/token';
import type { PairT } from 'bool-network-js/interfaces/uniswap';
import type { AuthorInfo, StatisticsInfo, WitnessProposal, WitnessType } from 'bool-network-js/interfaces/witness';
