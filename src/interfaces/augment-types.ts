...
import { AddressHash, BTCTransaction, BTCTxLog, BtcAddress, CandidateTx, NetWork, OutPoint, Params, ScriptType, TransactionInput, TransactionOutput, TxType, WithdrawRecord } from 'bool-network-js/interfaces/btcBridge';
...
import { AmountType, BidDetailT, BidT, CancelOrMatch, DepthInfo, DepthItem, OrderInfo, OrderPair, OrderStatus, OrderType, PerMill, PriceType, RegionT } from 'bool-network-js/interfaces/dex';
...
import { AccountList, Bids, Feed, List, PawnType, Vault } from 'bool-network-js/interfaces/stablecoin';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<WithdrawRecord>': Option<WithdrawRecord>;
    'Vec<WithdrawRecord>': Vec<WithdrawRecord>;
