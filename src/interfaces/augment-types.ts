...
import { AddressHash, BTCTransaction, BTCTxLog, BestHeader, BlockHeader, BlockHeaderu32, BtcAddress, CandidateTx, NetWork, OutPoint, Params, PartialMerkleTreeForTransport, ScriptType, TransactionInput, TransactionOutput, TransportRelayTx, TxType, UTXO, WithdrawRecordT } from 'bool-network-js/interfaces/btcBridge';
import { Authorities, AuthoritiesChangeType, CitaHeader } from 'bool-network-js/interfaces/citaBridge';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<PartialMerkleTreeForTransport>': Option<PartialMerkleTreeForTransport>;
    'Vec<PartialMerkleTreeForTransport>': Vec<PartialMerkleTreeForTransport>;
    UTXO: UTXO;
